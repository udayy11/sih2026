...
export const ProjectsTableView: React.FC<ProjectsTableViewProps> = ({
  ...
  // Sub-view toggle (Table vs Milestones vs Issues)
  const [projectSubView, setProjectSubView] = useState<'table' | 'milestones' | 'issues'>('table');
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Sub-view Navigation Toggle Tabs (Milestones & Issues integrated into Projects) */}
                      ...
                      <td className="py-3 px-3 max-w-[240px]">
                        <div className="flex items-start gap-1.5">
                          ...
                          <span className="text-[11px] font-medium text-slate-700 dark:text-slate-300 line-clamp-2" title={p.shortIssuesSummary || p.detectedIssue}>
                            {p.shortIssuesSummary || p.detectedIssue}
                          </span>
                        </div>
                      </td>
