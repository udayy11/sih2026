...
export const LoginView: React.FC<LoginViewProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 selection:bg-blue-600 selection:text-white relative">
      ...
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-xl border border-slate-200 overflow-hidden z-10">
        <div className="p-8 pb-6 border-b border-slate-100 bg-slate-900 text-white relative">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-900 via-blue-700 to-indigo-600 p-0.5 shadow-sm flex items-center justify-center">
              <div className="w-full h-full bg-blue-900 rounded-[10px] flex items-center justify-center">
                <Layers className="w-5 h-5 text-amber-400" />
              </div>
            </div>
            <div>
              <h1 className="text-xl font-extrabold tracking-tight">Nirmaan<span className="text-blue-400">X</span></h1>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 focus:border-blue-600 focus:bg-white focus:ring-2 focus:ring-blue-100 rounded-xl text-xs text-slate-800 placeholder-slate-400 transition-all outline-hidden font-mono"
                />
              </div>
            </div>
