...
const STOP_WORDS = new Set([
  ...
  'infrastructure', 'cause', 'causes', 'factor', 'factors', 'primary', 'main', 'top',
  'bottleneck', 'bottlenecks', 'reason', 'reasons', 'india', 'indian', 'overrun', 'overruns',
  'escalation', 'government', 'mospi', 'ministry', 'department', 'central', 'sector'
]);
